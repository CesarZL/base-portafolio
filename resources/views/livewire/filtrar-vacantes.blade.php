    ...
    <div class="max-w-7xl mx-auto">
        ...
        >
            <div class="md:grid md:grid-cols-3 gap-5">
                ...
                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 uppercase font-bold dark:text-gray-200">Categoría</label>
                    <select 
                    wire:model="categoria"
                    class="border-gray-300 p-2 w-full rounded-md shadow-sm">
